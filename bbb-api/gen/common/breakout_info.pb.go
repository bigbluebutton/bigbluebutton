...
var file_common_breakout_info_proto_goTypes = []interface{}{
...
func file_common_breakout_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_breakout_info_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BreakoutInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
