...
/* I made this fix to mconf-live0.7.3 main reconnection. When I merged with bbb-1.0.0 I was not sure if we still need it.
   Check this when the merged is completed. (Pedro, November/6/2015)
