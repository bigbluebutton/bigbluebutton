...
public class SendPageCountError implements IMessage {
	...
	public SendPageCountError(String messageKey, String meetingId,
	...
	public static SendPageCountError fromJson(String message) {
			...
			if (header.has("name")) {
				...
				if (SEND_PAGE_COUNT_ERROR.equals(messageName)) {
					if (payload.has(Constants.MEETING_ID) 
						...
						return new SendPageCountError(messageKey, meetingId, code, presId, numberOfPages, maxNumberPages, presName);
					}
				}
			}
		}
