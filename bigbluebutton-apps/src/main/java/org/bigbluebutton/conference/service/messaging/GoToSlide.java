...
public class GoToSlide implements IMessage {
	...
	public GoToSlide(String meetingId, String page){
	...
	public static GoToSlide fromJson(String message) {
			...
			if (header.has("name")) {
				...
				if (GO_TO_SLIDE.equals(messageName)) {
					if (payload.has(Constants.MEETING_ID)
						...
						return new GoToSlide(meetingId, page);
					}
				}
			}
		}
