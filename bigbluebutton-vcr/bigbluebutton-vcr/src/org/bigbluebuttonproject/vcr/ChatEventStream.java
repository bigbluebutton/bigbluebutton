...
/**
 * An event stream that listens for chat events.
 *
...
public class ChatEventStream extends EventStream {
	...
	/**
	 * Wait for a send event from the chatSO shared object, and dispatch.
	 */
	public void onSharedObjectSend(ISharedObjectBase so, String method, List params) {
		// if this is a newMessage event, extract the user name and message
		// then generate an XML tag for the chat event
