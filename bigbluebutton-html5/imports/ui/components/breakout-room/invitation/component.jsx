    ...
    if (hasBreakoutsAvailable
      ...
      if (lastBreakoutReceived) {
        ...
        || (typeof oldProps.breakoutRoomsUserIsIn === 'object'
          ...
          if (!isModerator || lastBreakoutReceived.includeMods) this.inviteUserToBreakout(lastBreakoutReceived);
        }
        ...
        if (maxSeq === freeJoinRooms.length) {
          ...
          if (!isModerator || randomRoom.includeMods) this.inviteUserToBreakout(randomRoom);
