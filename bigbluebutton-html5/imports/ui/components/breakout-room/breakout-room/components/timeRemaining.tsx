...
import { doesNotExceedRemainingTime, getRemainingMeetingTime } from '/imports/ui/core/utils/calculateRemaingTime';
          ...
          <Styled.FlexRow>
            ...
            <Styled.EndButton
              ...
              onClick={() => {
                ...
                if (!doesNotExceedRemainingTime(remainingTime, newTime * 60)) {
