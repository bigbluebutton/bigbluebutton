...
import {
  useIsChatEnabled,
  useIsMultiScreenshareEnabled,
  useIsPrivateChatEnabled,
...
const LockViewersContainer = (props) => {
  ...
  const updateLockSettings = (lockSettings) => {
    setLockSettingsProps({
      variables: {
        ...
        hideViewersScreenshare: lockSettings.hideViewersScreenshare,
        disableMultiScreenshare: lockSettings.disableMultiScreenshare,
      },
    });
  };
  ...
  return amIModerator && meeting && (
    <LockViewersComponent
      ...
      isMultiScreenshareEnabled={isMultiScreenshareEnabled}
      {...props}
    />
  );
};
