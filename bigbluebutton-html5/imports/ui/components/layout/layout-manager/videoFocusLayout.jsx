...
//     this.throttledCalculatesLayout = _.throttle(
...
//     return (
//       this.props.contextState.input !== nextProps.contextState.input ||
...
//         } else {
//           width = min(
//             max(input.sidebarNavigation.width, sidebarNavMinWidth),
//             sidebarNavMaxWidth
//           );
//         }
...
//         } else {
//           width = min(
//             max(input.sidebarContent.width, sidebarContentMinWidth),
//             sidebarContentMaxWidth
//           );
//         }
...
//           deviceType === DEVICE_TYPE.TABLET_PORTRAIT
//           ? 0
//           : sidebarNavWidth,
...
//           max(windowHeight() * 0.2, DEFAULT_VALUES.presentationMinHeight),
//           windowHeight() - DEFAULT_VALUES.presentationMinHeight
//         );
//       } else {
//         presentationBounds.height = min(
...
//       presentationBounds.top = windowHeight() - presentationBounds.height;
