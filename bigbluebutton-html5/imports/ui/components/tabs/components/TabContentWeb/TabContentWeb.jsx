...
const TabContentWeb = ({ activeKey, contentKey }) => {
  const contentShow = activeKey === 4 ? 'block' : 'hidden';
  ...
  return (
    <div className={`w-full py-3 flex flex-col overflow-y-scroll ${contentShow}`} id={`link${contentKey}`}>
      ...
      <ul>
        ...
        <Slide name="Web 3" image="images/slide-3.png" />
        <Slide name="Web 4" image="images/slide-4.png" />
      </ul>
    </div>
...
TabContentWeb.defaultProps = {
  activeKey: 0,
  contentKey: 1,
};

TabContentWeb.propTypes = {
