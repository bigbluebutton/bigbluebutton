...
class Uploader extends PureComponent {
  ...
  handleConfirm() {
    const {
      intl, handleSave, intlMessages, currentPresID, presentations: propPresentations,
    } = this.props;
    ...
    const hasNewUpload = presentations.length !== propPresentations.length;
  ...
  renderToastList() {
    ...
    return (
      <div className={styles.innerToastt}>
  ...
  renderPresentationItem(item) {
    ...
    const {
      intl, intlMessages, currentPresID, presentations,
    } = this.props;
