...
const QuestionQuizingTitle = styled.div`
  white-space: nowrap;
...
const QuestionQuizButtonWrapper = styled.div`
  text-align: center;
  padding: ${smPaddingY};
  width: 100%;
`;
...
const QuestionQuizingCheckbox = styled.div`
...
const QuestionQuizingContainer = styled.div`
  pointer-events:auto;
  min-width: ${pollWidth};
  position: absolute;
...
const QuestionQuizingAnswers = styled.div`
  display: grid;
...
export default {
  QuestionQuizingTitle,
  QuestionQuizButtonWrapper,
  QuestionQuizingButton,
  Hidden,
  TypedResponseWrapper,
  TypedResponseInput,
  SubmitVoteButton,
  QuestionQuizingSecret,
  MultipleResponseAnswersTable,
  QuestionQuizingCheckbox,
  CheckboxContainer,
  ...
  QTitle,
  QText,
  QuestionQuizingContainer,
  QuestionQuizingAnswers,
};
