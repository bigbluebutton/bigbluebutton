...
class ModalFileDrop extends PureComponent {
  constructor(props) {
    super(props);
...
ModalFileDrop.propTypes = propTypes;
ModalFileDrop.defaultProps = defaultProps;

export default withModalState(injectIntl(ModalFileDrop));
