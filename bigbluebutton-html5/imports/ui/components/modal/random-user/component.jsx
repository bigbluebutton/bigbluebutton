...
class RandomUserSelect extends Component {
  ...
  render() {
    ...
    const selectedUser = SELECT_RANDOM_USER_COUNTDOWN ? mappedRandomlySelectedUsers[counter][0] : mappedRandomlySelectedUsers[mappedRandomlySelectedUsers.length - 1][0];
