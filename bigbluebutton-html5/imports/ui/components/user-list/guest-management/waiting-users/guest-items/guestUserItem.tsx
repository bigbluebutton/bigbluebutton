          ...
          {showInput && (
            <Styled.InputWrapper>
              <Styled.Input
                ...
                maxLength={128}
                placeholder={intl.formatMessage(intlMessages.privateInputPlaceholder, { guestName: name })}
                aria-label={intl.formatMessage(intlMessages.privateInputPlaceholder, { guestName: name })}
                autoCorrect="off"
                autoComplete="off"
                spellCheck="true"
