...
const clearPreview = async (annotation) => {
  UnsentAnnotations.removeAsync({ id: annotation });
};

const clearFakeAnnotations = async () => {
  UnsentAnnotations.removeAsync({});
  Annotations.removeAsync({ id: /-fake/g });
}
