...
export default class EraserPointerListener extends Component {
  constructor() {
    super();
  ...
  commonDrawStartHandler(clientX, clientY) {
    ...
    this.handleDrawEraser(this.points, DRAW_START, generateNewShapeId());
  }
  ...
  handlePointerUp(event) {
    switch (event.pointerType) {
      ...
      default: {
        Logger.error({ logCode: 'eraser_pointer_listener_unkownPointerTypeError' }, 'PointerType is unknown or could not be detected!');
      }
    }
  }
...
EraserPointerListener.propTypes = {
