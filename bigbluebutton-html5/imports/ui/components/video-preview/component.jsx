...
class VideoPreview extends Component {
  ...
  componentDidMount() {
    ...
    const populatePreview = ({
      ...
      if (!digestedWebcams || digestedWebcams.length > 0) {
        this.getInitialCameraStream(digestedWebcams[0].deviceId)
          .then(async () => {
            ...
            if (!areLabelled || !areIdentified) {
              ...
              try {
                ...
                digestedWebcams = PreviewService.digestVideoDevices(
                  newDevices,
                  webcamDeviceId,
                ).webcams;
              } catch (error) {
            ...
            this.setState({
              availableWebcams: digestedWebcams,
