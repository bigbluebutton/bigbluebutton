...
var ShadowGenerator = /** @class */ (function () {
    ...
    ShadowGenerator.prototype._bindCustomEffectForRenderSubMeshForShadowMap = function (subMesh, effect) {
    };
    ShadowGenerator.prototype._renderSubMeshForShadowMap = function (subMesh) {
        ...
        if (this.isReady(subMesh, hardwareInstancedRendering)) {
            ...
            // Draw
            mesh._processRendering(subMesh, this._effect, material.fillMode, batch, hardwareInstancedRendering, function (isInstance, world) { return _this._effect.setMatrix("world", world); });
            if (this.forceBackFacesOnly) {
