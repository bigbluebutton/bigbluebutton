...
if (typeof jQuery === 'undefined') throw new Error("Bootstrap's JavaScript requires jQuery"); +(function (a) {
  ...
  }, a(() => { a.support.transition = b(), a.support.transition && (a.event.special.bsTransitionEnd = { bindType: a.support.transition.end, delegateType: a.support.transition.end, handle(b) { return a(b.target).is(this) ? b.handleObj.handler.apply(this, arguments) : void 0; } }); });
}(jQuery)), +(function (a) {
  function b(b) {
    ...
    d = function (b) { a(b).on('click', c, this.close); }; d.VERSION = '3.3.6', d.TRANSITION_DURATION = 150, d.prototype.close = function (b) {
  ...
  function b(b) {
    ...
    let c = this.getItemIndex(b),
     ...
     let b = this,
      c = this.getItemIndex(this.$active = this.$element.find('.item.active')); return a > this.$items.length - 1 || a < 0 ? void 0 : this.sliding ? this.$element.one('slid.bs.carousel', () => { b.to(a); }) : c == a ? this.pause().cycle() : this.slide(a > c ? 'next' : 'prev', this.$items.eq(a));
  ...
  function b(b) { let c = b.attr('data-target'); c || (c = b.attr('href'), c = c && /#[A-Za-z]/.test(c) && c.replace(/.*(?=#[^\s]*$)/, '')); const d = c && a(c); return d && d.length ? d : b.parent(); } function c(c) {
    ...
    g = function (b) { a(b).on('click.bs.dropdown', this.toggle); }; g.VERSION = '3.3.6', g.prototype.toggle = function (d) {
  ...
  } var c = function (b) { this.element = a(b); }; c.VERSION = '3.3.6', c.TRANSITION_DURATION = 150, c.prototype.show = function () {
    let b = this.element,
