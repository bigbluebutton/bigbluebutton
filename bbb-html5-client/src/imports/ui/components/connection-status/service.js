 ...
 *          peer
 */
export const getVideoData = async (getVideoStreamsStats) => {
 ...
 */
export const getNetworkData = async (getVideoStreamsStats) => {
...
export const sortConnectionData = (connectionData) => connectionData.sort(sortLevel).sort(sortOnline);
