...
OUT_DIR="./gen"
BASE_PACKAGE="github.com/bigbluebutton/bigbluebutton/bigbluebutton-api/gen"
...
find "${PROTO_DIR}" -name "*.proto" -exec protoc \
    ...
    --go_opt=Mcore/create_meeting_request.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/create_meeting_response.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/get_meetings_stream_request.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/list_meetings_request.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/list_meetings_response.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/meeting_info_request.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/meeting_info_response.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/meeting_running_request.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/meeting_running_response.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/service.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/voice_bridge_in_use_request.proto=${BASE_PACKAGE}/core \
    --go_opt=Mcore/voice_bridge_in_use_response.proto=${BASE_PACKAGE}/core \
    --go-grpc_out="${OUT_DIR}" \
    ...
    --go-grpc_opt=Mcore/create_meeting_request.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/create_meeting_response.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/get_meetings_stream_request.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/list_meetings_request.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/list_meetings_response.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/meeting_info_request.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/meeting_info_response.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/meeting_running_request.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/meeting_running_response.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/service.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/voice_bridge_in_use_request.proto=${BASE_PACKAGE}/core \
    --go-grpc_opt=Mcore/voice_bridge_in_use_response.proto=${BASE_PACKAGE}/core \
    '{}' \;