...
public class StreamDownsizer implements IImageProvider {
	...
	private IVideoPictureListener pictureListener;
	...
	public StreamDownsizer(IBroadcastStream inputStream, IPacketListener packetListener, 
			IVideoPictureListener pictureListener){
