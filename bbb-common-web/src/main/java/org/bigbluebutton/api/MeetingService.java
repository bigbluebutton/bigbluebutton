...
public class MeetingService implements MessageListener {
  ...
  public void registerUser(String meetingID, String internalUserId,
    ...
    handle(
            new RegisterUser(meetingID, internalUserId, fullname, firstName, lastName, role,
                            ...
                            excludeFromDashboard, leftGuestLobby, enforceLayout, logoutUrl, ipAddress, userAgent, referer, userMetadata
            )
    );
  ...
  private void processRegisterUser(RegisterUser message) {
    gw.registerUser(message.meetingID,
      ...
      message.ipAddress, message.userAgent, message.referer, message.userMetadata);
  }
