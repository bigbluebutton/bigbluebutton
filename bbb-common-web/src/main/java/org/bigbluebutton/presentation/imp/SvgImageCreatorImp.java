...
public class SvgImageCreatorImp implements SvgImageCreator {
    ...
    private PdfFontType3DetectorHandler createDetectFontType3tHandler(boolean done, int page, String source, UploadedPresentation pres) {
        ...
        PdfFontType3DetectorHandler detectFontType3tHandler = new PdfFontType3DetectorHandler("font3pdf-" + pres.getId() + "-" + page);
    ...
    private boolean generateSvgImage(File imagePresentationDir, UploadedPresentation pres, int page)
        ...
        SvgConversionHandler pHandler = new SvgConversionHandler("pdf2svg-" + pres.getId() + "-" + page);
        ...
        if (destsvg.length() == 0 ||
            ...
            Pdf2PngPageConverterHandler pngHandler = new Pdf2PngPageConverterHandler("pdf2png-" + pres.getId() + "-" + page);
            ...
            if(tempPng.length() > 0) {
                ...
                if(destsvg.length() > 0) {
                    ...
                    AddNamespaceToSvgHandler namespaceHandler = new AddNamespaceToSvgHandler("svg-namespace-" + pres.getId() + "-" + page);
