...
public interface IBbbWebApiGWApp {
  ...
  void createMeeting(String meetingID, String externalMeetingID,
                     ...
                     String moderatorPass, String viewerPass, Boolean learningDashboardEnabled,
                     String learningDashboardAccessToken, String learningDashboardExcludeUserID, Long createTime,
