...
/*****
  ...
  def createMeeting(meetingId: String, extMeetingId: String, parentMeetingId: String, meetingName: String,
                    ...
                    amountOfTimeToConsiderUserAsInactiveInMinutes:       java.lang.Integer,
                    amountOfTimeToDisconnectUserIfUnresponsiveInMinutes: java.lang.Integer,
    ...
    val durationProps = DurationProps(
      ...
      amountOfTimeToConsiderUserAsInactiveInMinutes = amountOfTimeToConsiderUserAsInactiveInMinutes.intValue(),
      amountOfTimeToDisconnectUserIfUnresponsiveInMinutes = amountOfTimeToDisconnectUserIfUnresponsiveInMinutes.intValue())
