...
class OldMeetingMsgHdlrActor(val olgMsgGW: OldMessageReceivedGW)
  ...
  def handlePresentationUploadTokenSysPubMsg(msg: PresentationUploadTokenSysPubMsg): Unit = {
    olgMsgGW.handle(new PresentationUploadToken(msg.body.podId, msg.body.authzToken, msg.body.filename, msg.body.meetingId, msg.body.presentationId, msg.header.userId))
  }
