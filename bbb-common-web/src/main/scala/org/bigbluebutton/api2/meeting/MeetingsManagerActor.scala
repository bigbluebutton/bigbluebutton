...
case class RegisterUser(meetingId: String, intUserId: String, name: String, firstName: String, lastName: String, role: String,
                        ...
                        enforceLayout: String, logoutUrl: String, ipAddress: String, userAgent: String, referer: String, userMetadata: Map[String, String])
