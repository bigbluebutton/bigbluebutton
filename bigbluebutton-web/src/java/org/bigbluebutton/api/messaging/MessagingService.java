...
public interface MessagingService {	
	...
	void publishRecording(String meetingId, String externalMeetingId, String format, boolean publish);
	void deleteRecording(String meetingId, String externalMeetingId, String format);
}
