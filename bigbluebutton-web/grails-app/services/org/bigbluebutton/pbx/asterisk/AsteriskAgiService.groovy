					...
					if ((startTime < now) && (endTime > now)) {				
						 ...
						 */
						 ...
						 if (conf.record) {
							 ...
							 RECORD_OPTION = "r"
							 def recordDir = "/var/spool/asterisk/meetme/${now}-$number-conf-record"
							 log.debug "Recording voice conference $recordDir"
							 channel.setVariable("MEETME_RECORDINGFILE", recordDir)
						 } else {
