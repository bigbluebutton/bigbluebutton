...
class SessionManagerGateway(streamManager: StreamManager, keyFrameInterval: Int, interframeInterval: Int) extends ISessionManagerGateway {  
	
	private val log = Logger.get 

	streamManager.start
	val sessionManager: SessionManagerSVC = new SessionManagerSVC(streamManager, keyFrameInterval, interframeInterval)
