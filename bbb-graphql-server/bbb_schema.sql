...
SELECT "meeting_usersPolicies"."meetingId",
    ...
    "meeting_usersPolicies"."userScreenshareCap",
...
create unlogged table "meeting_lockSettings" (
    ...
    "disableMultiScreenshare"  boolean default false
);
...
"hasAudio" boolean,
"userId" varchar(100),
"trackSid" varchar(100),
"showAsContent" boolean DEFAULT true,
"startedAt" timestamp with time zone,
"stoppedAt" timestamp with time zone
