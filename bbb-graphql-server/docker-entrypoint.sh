...
export PGUSER="${BBB_POSTGRES_USER}"
export PGPASSWORD="${BBB_POSTGRES_PASSWORD}"


# for hasura
export HASURA_GRAPHQL_DATABASE_URL=postgres://${BBB_POSTGRES_USER}:${BBB_POSTGRES_PASSWORD}@postgres:5432/hasura_app
export HASURA_GRAPHQL_METADATA_DATABASE_URL=postgres://${BBB_POSTGRES_USER}:${BBB_POSTGRES_PASSWORD}@postgres:5432/hasura_app
...
export HASURA_GRAPHQL_BBB_DATABASE_URL=postgres://${BBB_POSTGRES_USER}:${BBB_POSTGRES_PASSWORD}@postgres:5432/bbb_graphql
