...
# for hasura
export HASURA_GRAPHQL_DATABASE_URL=postgres://hasura_app:${BBB_POSTGRES_HASURA_APP_PASSWORD}@postgres:5432/hasura_app
export HASURA_GRAPHQL_METADATA_DATABASE_URL=postgres://hasura_app:${BBB_POSTGRES_HASURA_APP_PASSWORD}@postgres:5432/hasura_app
