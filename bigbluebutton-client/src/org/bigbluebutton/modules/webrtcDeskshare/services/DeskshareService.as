...
*
*/
package org.bigbluebutton.modules.webrtcDeskshare.services
{
	...
	import org.bigbluebutton.modules.webrtcDeskshare.services.red5.Connection;
	...
	public class DeskshareService
	{
		...
		public function connect(uri:String, room:String):void {
			...
			conn = new Connection(room); //to red5 deskshare
