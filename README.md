...
For more information on the latest release -- including installation instructions, demo server, and overview of architecture -- see [http://docs.bigbluebutton.org/](http://docs.bigbluebutton.org/).
