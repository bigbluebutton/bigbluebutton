...
class QuestionQuizPublishedRecordEvent extends AbstractQuestionQuizRecordEvent {
  import QuestionQuizPublishedRecordEvent._

  setEvent("QuestionQuizPublishedRecordEvent")
...
object QuestionQuizPublishedRecordEvent {
