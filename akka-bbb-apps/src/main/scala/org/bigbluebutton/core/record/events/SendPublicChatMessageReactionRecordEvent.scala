...
class SendPublicChatMessageReactionRecordEvent extends AbstractChatRecordEvent {
  import SendPublicChatMessageReactionRecordEvent._
...
object SendPublicChatMessageReactionRecordEvent {
