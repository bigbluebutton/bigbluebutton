...
class ModifyTextWhiteboardRecordEvent extends AbstractWhiteboardRecordEvent {
  import ModifyTextWhiteboardRecordEvent._
...
object ModifyTextWhiteboardRecordEvent {
