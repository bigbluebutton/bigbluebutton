...
//  val messageId = column[Option[String]]("messageId", O.PrimaryKey) //// The messageId is generated by the database
  ...
  override def * = (meetingId, pluginName, dataChannel, subChannelName, payloadJson, fromUserId, toRoles, toUserIds, createdAt, deletedAt) <> (PluginDataChannelMessageDbModel.tupled, PluginDataChannelMessageDbModel.unapply)
}

object PluginDataChannelMessageDAO {
  def insert(meetingId: String, pluginName: String, dataChannel: String, subChannelName: String, senderUserId: String, payloadJson: String, toRoles: List[String], toUserIds: List[String]) = {
  ...
  def reset(meetingId: String, pluginName: String,
            dataChannel: String, subChannelName: String) = {
    DatabaseConnection.db.run(
  ...
  def getMessageSender(meetingId: String, pluginName: String, dataChannel: String,
                       subChannelName: String, messageId: String): String = {
  ...
  def delete(meetingId: String, pluginName: String,
             dataChannel: String, subChannelName: String,  messageId: String) = {
    DatabaseConnection.db.run(
