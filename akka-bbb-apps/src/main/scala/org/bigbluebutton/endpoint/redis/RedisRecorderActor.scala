...
class RedisRecorderActor(
  ...
  system.scheduler.scheduleWithFixedDelay(1.minutes, 1.minutes, self, CheckRecordingDBStatus)
  ...
  private def handleGroupChatMessageBroadcastEvtMsg(msg: GroupChatMessageBroadcastEvtMsg): Unit = {
  ...
  private def handleGroupChatMessageEditedEvtMsg(msg: GroupChatMessageEditedEvtMsg): Unit = {
    if (msg.body.chatId == GroupChatApp.MAIN_PUBLIC_CHAT) {
  ...
  private def handleGroupChatMessageDeletedEvtMsg(msg: GroupChatMessageDeletedEvtMsg): Unit = {
    if (msg.body.chatId == GroupChatApp.MAIN_PUBLIC_CHAT) {
  ...
  private def handleGroupChatMessageReactionSentEvtMsg(msg: GroupChatMessageReactionSentEvtMsg): Unit = {
    if (msg.body.chatId == GroupChatApp.MAIN_PUBLIC_CHAT) {
  ...
  private def handleGroupChatMessageReactionDeletedEvtMsg(msg: GroupChatMessageReactionDeletedEvtMsg): Unit = {
    if (msg.body.chatId == GroupChatApp.MAIN_PUBLIC_CHAT) {
  ...
  private def handleClearPublicChatHistoryEvtMsg(msg: ClearPublicChatHistoryEvtMsg): Unit = {
  ...
  private def handlePresentationConversionCompletedEvtMsg(msg: PresentationConversionCompletedEvtMsg): Unit = {
  ...
  private def handleSetCurrentPageEvtMsg(msg: SetCurrentPageEvtMsg): Unit = {
  ...
  private def handleResizeAndMovePageEvtMsg(msg: ResizeAndMovePageEvtMsg): Unit = {
  ...
  private def handleRemovePresentationEvtMsg(msg: RemovePresentationEvtMsg): Unit = {
  ...
  private def handleSetPresentationDownloadableEvtMsg(msg: SetPresentationDownloadableEvtMsg): Unit = {
  ...
  private def handleSetCurrentPresentationEvtMsg(msg: SetCurrentPresentationEvtMsg): Unit = {
    recordSharePresentationEvent(msg.header.meetingId, msg.body.podId, msg.body.presentationId)
  }

  private def handleCreateNewPresentationPodEvtMsg(msg: CreateNewPresentationPodEvtMsg): Unit = {
  ...
  private def handleRemovePresentationPodEvtMsg(msg: RemovePresentationPodEvtMsg): Unit = {
  ...
  private def handleSetPresenterInPodRespMsg(msg: SetPresenterInPodRespMsg): Unit = {
  ...
  private def recordSharePresentationEvent(meetingId: String, podId: String, presentationId: String): Unit = {
  ...
  private def handleSendWhiteboardAnnotationsEvtMsg(msg: SendWhiteboardAnnotationsEvtMsg): Unit = {
  ...
  private def handleSendCursorPositionEvtMsg(msg: SendCursorPositionEvtMsg): Unit = {
  ...
  private def handleClearWhiteboardEvtMsg(msg: ClearWhiteboardEvtMsg): Unit = {
  ...
  private def handleDeleteWhiteboardAnnotationsEvtMsg(msg: DeleteWhiteboardAnnotationsEvtMsg): Unit = {
  ...
  private def handleUserRoleChangedEvtMsg(msg: UserRoleChangedEvtMsg): Unit = {
    handleUserStatusChange(msg.header.meetingId, msg.body.userId, "role", msg.body.role)
  }

  private def handleUserBroadcastCamStartedEvtMsg(msg: UserBroadcastCamStartedEvtMsg): Unit = {
    handleUserStatusChange(msg.header.meetingId, msg.body.userId, "hasStream", "true,stream=" + msg.body.stream)
  }

  private def handleUserBroadcastCamStoppedEvtMsg(msg: UserBroadcastCamStoppedEvtMsg): Unit = {
  ...
  private def handleUserMutedVoiceEvtMsg(msg: UserMutedVoiceEvtMsg): Unit = {
  ...
  private def handleUserTalkingVoiceEvtMsg(msg: UserTalkingVoiceEvtMsg): Unit = {
  ...
  private def handleVoiceRecordingStartedEvtMsg(msg: VoiceRecordingStartedEvtMsg): Unit = {
  ...
  private def handleVoiceRecordingStoppedEvtMsg(msg: VoiceRecordingStoppedEvtMsg): Unit = {
  ...
  private def handleAudioFloorChangedEvtMsg(msg: AudioFloorChangedEvtMsg): Unit = {
  ...
  private def handleEditCaptionHistoryEvtMsg(msg: EditCaptionHistoryEvtMsg): Unit = {
  ...
  private def handlePadCreatedRespMsg(msg: PadCreatedRespMsg): Unit = {
  ...
  */
  ...
  private def handleStartExternalVideoEvtMsg(msg: StartExternalVideoEvtMsg): Unit = {
  ...
  private def handleUpdateExternalVideoEvtMsg(msg: UpdateExternalVideoEvtMsg): Unit = {
  ...
  private def handleStopExternalVideoEvtMsg(msg: StopExternalVideoEvtMsg): Unit = {
  ...
  private def handleActivateTimerRespMsg(msg: ActivateTimerRespMsg): Unit = {
  ...
  private def handleDeactivateTimerRespMsg(msg: DeactivateTimerRespMsg): Unit = {
  ...
  private def handleStartTimerRespMsg(msg: StartTimerRespMsg): Unit = {
  ...
  private def handleStopTimerRespMsg(msg: StopTimerRespMsg): Unit = {
  ...
  private def handleSwitchTimerRespMsg(msg: SwitchTimerRespMsg): Unit = {
  ...
  private def handleSetTimerRespMsg(msg: SetTimerRespMsg): Unit = {
  ...
  private def handleResetTimerRespMsg(msg: ResetTimerRespMsg): Unit = {
  ...
  private def handleTimerEndedEvtMsg(msg: TimerEndedEvtMsg): Unit = {
  ...
  private def handleSetTrackRespMsg(msg: SetTrackRespMsg): Unit = {
  ...
  private def handleRecordingStatusChangedEvtMsg(msg: RecordingStatusChangedEvtMsg): Unit = {
  ...
  private def handleRecordStatusResetSysMsg(msg: RecordStatusResetSysMsg): Unit = {
  ...
  private def handleWebcamsOnlyForModeratorChangedEvtMsg(msg: WebcamsOnlyForModeratorChangedEvtMsg): Unit = {
