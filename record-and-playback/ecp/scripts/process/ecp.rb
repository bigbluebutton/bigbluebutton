...
opts = Trollop::options do
  #opt :meeting_id, "Meeting id to archive", :default => 'a1b230784ef6ed4e8c522bf4670309905179ad56-1332661014243', :type => String
  opt :meeting_id, "Meeting id to archive", :default => 'd9ab062b221350a7b6fcacc6970435c1f651859d-1332487357860', :type => String
end

meeting_id = opts[:meeting_id]

logger = Logger.new("/var/log/bigbluebutton/ecp/process-#{meeting_id}.log", 'daily' )
...
target_dir = "#{recording_dir}/process/ecp/#{meeting_id}"
  ...
  BigBlueButton.process_webcam_deskshare(target_dir, temp_dir, meeting_id)
