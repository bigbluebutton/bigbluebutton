...
unless FileTest.directory?(target_dir)
  ...
  begin
    ...
    if !Dir["#{raw_archive_dir}/video/*"].empty? ||
      ...
      BigBlueButton.process_webcam_videos(target_dir, raw_archive_dir, webcam_width, webcam_height, webcam_framerate, presentation_props['audio_offset'], processed_audio_file, presentation_props['video_formats'], props['showModeratorViewpoint'])
    end
