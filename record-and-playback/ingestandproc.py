...
def main():
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:], "hm:a:p:r:e:o:i:b:s:k:", ["help", "meeting-id=", "audio-dir=", 
                                                "presentation-dir=", "archive-dir=", "redis-host=", 
                                                "redis-port=", "ingest-dir=", "publish-dir=",
                                                "scripts-dir=", "playback-host="])
