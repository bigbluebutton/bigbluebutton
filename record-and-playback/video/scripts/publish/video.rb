...
video_props = BigBlueButton.load_yaml(File.expand_path('../video.yml', __dir__))
begin
  video_props_override = BigBlueButton.load_yaml('/etc/bigbluebutton/recording/video.yml', fallback: {})
