package org.bigbluebutton.lib.settings.views {
	...
	public class SettingsViewMediatorBase extends Mediator {
		...
		override public function initialize():void {
			...
			view.settingsList.dataProvider = dataProvider = new ArrayCollection([{label: "Audio", icon: "icon-audio", page: "audio"}, {label: "Video", icon: "icon-video", page: "video"}, {label: "Application", icon: "icon-application", page: "chat"}, {label: "Participants", icon: "icon-user", page: "lock"}]);
