...
trait TestFixtures {
  ...
  val modsRequestToUnmuteUsers = false
  ...
  val usersProp = UsersProp(maxUsers = maxUsers, webcamsOnlyForModerator = webcamsOnlyForModerator,
    ...
    guestPolicy = guestPolicy, allowModsToUnmuteUsers = allowModsToUnmuteUsers, modsRequestToUnmuteUsers = modsRequestToUnmuteUsers, allowModsToEjectCameras = allowModsToEjectCameras, authenticatedGuest = authenticatedGuest, allowPromoteGuestToModerator = allowPromoteGuestToModerator)
