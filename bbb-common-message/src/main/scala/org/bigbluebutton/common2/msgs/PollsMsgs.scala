...
case class PollStartedEvtMsgBody(userId: String, pollId: String, pollType: String, question: String, poll: SimplePollOutVO, anonymous: Boolean)
...
case class StartCustomPollReqMsgBody(requesterId: String, pollId: String, pollType: String, answers: Seq[String], question: String, anonymous: Boolean)
...
case class StartPollReqMsgBody(requesterId: String, pollId: String, pollType: String, question: String, anonymous: Boolean)
