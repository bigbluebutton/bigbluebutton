...
case class UpdateExternalVideoPubMsgBody(eventName: String, rate: Double, time: Double, state: Int)
...
case class UpdateExternalVideoEvtMsgBody(eventName: String, rate: Double, time: Double, state: Int)
