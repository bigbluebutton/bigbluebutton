...
case class UsersProp(maxUsers: Int, webcamsOnlyForModerator: Boolean, guestPolicy: String, allowModsToUnmuteUsers: Boolean, allowModsToChangeUsernames: Boolean, authenticatedGuest: Boolean)
