...
case "$1" in
    install|upgrade|1|2)
        ...
        if [ -f /var/lib/tomcat9/webapps/bigbluebutton/WEB-INF/classes/bigbluebutton.properties ]; then
          mv -f /var/lib/tomcat9/webapps/bigbluebutton/WEB-INF/classes/bigbluebutton.properties /tmp
          ...
          rm /var/lib/tomcat9/webapps/bigbluebutton.war
        else  
