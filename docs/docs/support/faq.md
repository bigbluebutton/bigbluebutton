...
The conversion to PDF will remove any animations (visual or audio), links, and embedded content. At the end of the conversion, you'll see the final slide within BigBlueButton. Splitting the animated slide into multiple slides with intermediate animation steps using [PPspliT](https://github.com/maxonthegit/PPspliT) would be a good option.
