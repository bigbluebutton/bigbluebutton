...
| `userdata-bbb_record_permission=` | (Introduced in BigBlueButton 3.0) If set to `true` or `false`, the user will ignore the moderator/viewer role checks and be enabled/disabled to start and stop recording.                                                                                                                   | `null`        |
