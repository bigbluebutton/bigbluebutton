...
|---|---|---|---|
| `defaultMeetingLayout` | Default meeting layout | UNIFIED_LAYOUT, CUSTOM_LAYOUT, SMART_LAYOUT, PRESENTATION_FOCUS, VIDEO_FOCUS | CUSTOM_LAYOUT _`overwritable`_ (via `meetingLayout`) |
