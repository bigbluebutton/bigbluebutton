...
- `allowModsToRequestCameraShare` added in BBB 4.1 (default `false`). When `true`, moderators may ask a participant to share their webcam; the participant accepts or declines.
