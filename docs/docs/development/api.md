...
- **create**
 - **Added** `meetingLayout` now supports option UNIFIED_LAYOUT **Removed:** Parameter `meetingLayout` no longer supports: CUSTOM_LAYOUT, SMART_LAYOUT, PRESENTATION_FOCUS, VIDEO_FOCUS; 
