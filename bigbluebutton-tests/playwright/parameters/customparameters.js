...
class CustomParameters extends MultiUsers {
  ...
  async predefinedGroups() {
    ...
    await this.modPage.hasValue(e.roomNameInput1, 'Room 1', 'should display the correct name of the group for breakout room 1');
    ...
    await this.modPage.hasValue(e.roomNameInput2, 'Room 2', 'should display the correct name of the group for breakout room 2');
