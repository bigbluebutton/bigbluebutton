...
export class ChatPluginDomElements extends Chat {
  ...
  // Returns the total number of rendered messages, which includes the system ones already
  // in the chat when the meeting starts (the presenter announcement) - plugins are handed
  // those too
