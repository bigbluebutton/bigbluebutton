...
case class CreateMeeting(
  ...
  viewerPass: String,
  createTime: Long,
  createDate: String) extends InMessage
...
case class RegisterUser(
  ...
  role: Role,
  extUserID: String,
  authToken: String) extends InMessage
...
case class ChangeUserStatus(
  ...
  userID: String,
  status: String,
  value: Object) extends InMessage
...
case class GetChatHistoryRequest(
  meetingID: String,
  requesterID: String,
  replyTo: String) extends InMessage
...
case class BroadcastLayoutRequest(
  meetingID: String,
  requesterID: String,
  layout: String) extends InMessage
...
case class ClearPoll(
  ...
  requesterID: String,
  pollID: String,
  force: Boolean = false) extends InMessage
...
case class RemovePresentation(
  meetingID: String,
  presentationID: String) extends InMessage
...
case class SendCursorUpdate(
  meetingID: String,
  xPercent: Double,
  yPercent: Double) extends InMessage
...
case class ResizeAndMoveSlide(
  ...
  yOffset: Double,
  widthRatio: Double,
  heightRatio: Double) extends InMessage

case class GotoSlide(
  meetingID: String,
  page: String) extends InMessage

case class SharePresentation(
  meetingID: String,
  presentationID: String,
  share: Boolean) extends InMessage
...
case class PresentationConversionUpdate(
  ...
  code: String,
  presentationId: String,
  presName: String) extends InMessage
...
case class SendWhiteboardAnnotationRequest(
  meetingID: String,
  requesterID: String,
  annotation: AnnotationVO) extends InMessage
...
case class ClearWhiteboardRequest(
  meetingID: String,
  requesterID: String,
  whiteboardId: String) extends InMessage
...
case class EnableWhiteboardRequest(
  meetingID: String,
  requesterID: String,
  enable: Boolean) extends InMessage
...
case class GetAllMeetingsRequest(
  meetingID: String /** Not used. Just to satisfy trait **/ ) extends InMessage
