...
case class GetCurrentLayoutReply(
  ...
  layoutID: String,
  locked: Boolean,
  setByUserID: String) extends IOutMessage
...
case class GetPollResultReply(
  ...
  recorded: Boolean,
  requesterID: String,
  pollVO: PollVO) extends IOutMessage

case class GetPollsReplyOutMsg(
  meetingID: String,
  recorded: Boolean,
  requesterID: String,
  polls: Array[PollVO]) extends IOutMessage

case class ClearPollFailed(
  meetingID: String,
  pollID: String,
  requesterID: String,
  reason: String) extends IOutMessage

case class PollClearedOutMsg(
  meetingID: String,
  recorded: Boolean,
  pollID: String) extends IOutMessage
...
case class PollResponseOutMsg(
  ...
  recorded: Boolean,
  responder: Responder,
  response: PollResponseVO) extends IOutMessage
