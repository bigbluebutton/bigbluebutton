define [ "socket.io" ], (io) ->
  ...
  # in the future, to change the port:
  ...
  # @return {undefined}
  Connection.emitMakeShape = (shape, data) ->
  ...
  # @return {undefined}
  Connection.emitUpdateShape = (shape, data) ->
  ...
  # @return {undefined}
  Connection.emitPaperUpdate = (cx, cy, sw, sh) ->
